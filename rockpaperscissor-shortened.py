...
if(Computer_choice == Player):
    ...
    if((Computer_choice - Player == 2) or (Computer_choice - Player == - 1) ):
        print("Computer Won!")
    else:
        if((Computer_choice - Player == -2) or (Computer_choice - Player == 1) ):
            print("You Won!")
    # if(Computer_choice == 1 and Player == -1):2
    #     print("Computer Won!")
    # elif(Computer_choice == 1 and Player == 0):1
    #     print("You Won!")
    # elif(Computer_choice == 0 and Player == 1):-1
    #     print("Computer Won!")
    # elif(Computer_choice == 0 and Player ==-1):1
    #     print("You Won!")
    # elif(Computer_choice == -1 and Player == 1):-2
    #     print("You Won!")
    # elif(Computer_choice == -1 and Player == 0):-1
    #     print("Computer Won!")
        else:
